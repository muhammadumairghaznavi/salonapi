...
<head>
    ...
    <script type="text/javascript" src="{{asset('vendor/jquery/jquery.tabledit.js')}}"></script>
                        ...
                        <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul id="product" class="collapse list-unstyled ">
                                ...
                                @if ($index_permission_active)
                                    ...
                                    <li id=""><a href="{{ route('deals.index') }}">Deal List</a></li>
                                    <li id=""><a href="{{ route('services.index') }}">Service List</a></li>
                                    <?php
                                    ...
                                    @if ($add_permission_active)
                                        <li id="product-create-menu"><a href="{{ route('products.create') }}">Add
                    ...
                    @if ($index_permission_active)
                        ...
                        <li>
                            ...
                            <ul id="schedule" class="collapse list-unstyled ">
                                <li id="schedule-list-menu"><a href="{{ route('schedules.rules') }}">Rules &
                                        Regulations</a>
                                </li>
                                <li id="schedule-list-menu"><a href="{{ route('schedules.lunch') }}">Lunch Chart</a>
                                </li>
                                <li id="schedule-list-menu"><a href="{{ route('schedules.cleaning') }}">Cleaning
                                        Chart</a>
                                </li>
                            </ul>
                        </li>

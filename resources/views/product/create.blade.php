                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mt-3">
                                        ...
                                        <p class="italic">{{ trans('file.Featured item will be displayed in POS') }}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="help-text"></strong> </label> <label for="">Image</label> <i class="dripicons-question" data-toggle="tooltip" title="{{ trans('file.You can upload multiple image. Only .jpeg, .jpg, .png, .gif file can be uploaded. First image will be base image.') }}"></i>
                                        ...
                                        <div class="col-md-12" id="material_table">
                                            <table class="table table-stripped" border="1">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><label>{{Form::checkbox('material[]', $item->id, false, ['class' => 'name', 'id' => 'material_item'])}}</label></td>
                                                        <td>{{$item->name}}</td>
                                                        <td>{{$item->price}}</td>
                                                    </tr>
                                                    @endforeach

                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="help-text">  </strong> </label> <label> Name *</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="help-text"></strong></label> <label>Code *</label>
                                        <div class="input-group">
                                ...
                                <div id="alert-qty" class="col-md-4">
                                    <div class="form-group">
                                        <label class="help-text"></strong> </label> <label for="">Alert Quantity *</label>
                                        <input type="number" name="alert_quantity" class="form-control" step="any">
                                    </div>
                                </div>
                                <div id="cost" class="col-md-4">
                                    <div class="form-group">
                                       <label class="product_cost"><?php echo e(trans('file.Product Cost')); ?> *</strong> </label>
                                ...
                                <div id="unit" class="col-md-12">
                                    <div class="row ">
                                        <div class="col-md-4 form-group">
                                            <label class="help-text"></strong> </label> <label for="">Unit *</label>
                                            <div class="input-group">
                                                <select required class="form-control selectpicker" name="unit_id">
                                                    ...
                                                    <option value="<?php echo e($unit->id); ?>"><?php echo e($unit->unit_name); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mt-3">
                                        ...
                                        <p class="italic"><?php echo e(trans('file.Featured item will be displayed in POS')); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="help-text"></strong> </label> <label for="">Image</label> <i class="dripicons-question" data-toggle="tooltip" title="<?php echo e(trans('file.You can upload multiple image. Only .jpeg, .jpg, .png, .gif file can be uploaded. First image will be base image.')); ?>"></i>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-12" id="material_table">
...
<script type="text/javascript">
    ...
    $("#material_used").on("change", function(){
        if($(this).is(':checked')){
            $("#material_table").show(300);
        }
        else{
            $("#material_table").hide(300);
        }
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\salonapi\resources\views/product/create.blade.php ENDPATH**/ ?>
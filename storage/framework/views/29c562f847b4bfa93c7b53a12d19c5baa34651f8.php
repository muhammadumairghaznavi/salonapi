                        ...
                        <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul id="product" class="collapse list-unstyled ">
                                ...
                                <?php if($index_permission_active): ?>
                                    ...
                                    <li id=""><a href="<?php echo e(route('deals.index')); ?>">Deal List</a></li>
                                    <li id=""><a href="<?php echo e(route('services.index')); ?>">Service List</a></li>
                                    <?php
                                    ...
                                    <?php if($add_permission_active): ?>
                                        <li id="product-create-menu"><a href="<?php echo e(route('products.create')); ?>">Add
                                                Product/Deal/Service</a></li>
                                    <?php endif; ?>
                                <?php endif; ?>
                            ...
                            <ul id="return" class="collapse list-unstyled ">
                                <?php if($sale_return_index_permission_active): ?>
                                    <li id="sale-return-menu"><a
                                            href="<?php echo e(route('return-sale.index')); ?>"><?php echo e(trans('file.Sale')); ?></a>
                                    </li>
                                <?php endif; ?>
                            ...
                            <ul id="hrm" class="collapse list-unstyled ">
                                ...
                                <?php if($payroll_active): ?>
                                    <li id="payroll-menu"><a
                                            href="<?php echo e(route('payroll.index')); ?>"><?php echo e(trans('file.Payroll')); ?></a>
                                    </li>
                                <?php endif; ?>
                            ...
                            <ul id="people" class="collapse list-unstyled ">
                                ...
                                <?php if($user_index_permission_active): ?>
                                    <li id="user-list-menu"><a
                                            href="<?php echo e(route('user.index')); ?>"><?php echo e(trans('file.User List')); ?></a>
                                    </li>
                        ...
                        <ul id="setting" class="collapse list-unstyled ">
                            ...
                            <?php if($currency_permission_active): ?>
                                <li id="currency-menu"><a
                                        href="<?php echo e(route('currency.index')); ?>"><?php echo e(trans('file.Currency')); ?></a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if($backup_database_permission_active): ?>
                                <li><a
                                        href="<?php echo e(route('setting.backup')); ?>"><?php echo e(trans('file.Backup Database')); ?></a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if($sms_setting_permission_active): ?>
                                <li id="sms-setting-menu"><a
                                        href="<?php echo e(route('setting.sms')); ?>"><?php echo e(trans('file.SMS Setting')); ?></a>
                                </li>
                            <?php endif; ?>
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a href="<?php echo e(url('language_switch/pt_BR')); ?>" class="btn btn-link">
                                        Portuguese</a>
                                </li>
                                <li>
...
<?php /**PATH D:\xampp\htdocs\salonapi\resources\views/layout/main.blade.php ENDPATH**/ ?>